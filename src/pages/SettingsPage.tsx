      ...
      <div className="flex flex-col gap-8">
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-5 space-y-4 text-sm text-slate-600">
            <p>
              <strong>Data Storage:</strong> ViewTube prioritizes your privacy.
              We do not store any of your watch history, search queries, or
              watch later playlists on external servers. All personal data
              generated during your session is saved strictly locally within
              your browser using{' '}
            ...
            <p>
              <strong>YouTube API:</strong> This application utilizes the
              official YouTube Data API v3 to fetch videos, comments, and
              channel details. By using this application, you agree to be bound
              by the{' '}
              <a
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Select your default region for trending videos.
                </p>
              </div>
              <select
                value={region}
        ...
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="text-sm text-slate-600 max-w-xl">
              <p>
                You can instantly delete all locally stored preferences, watch
                history, and playlists from this browser. This action is
                irreversible.
              </p>
            </div>
