...
export function usePlaylists() {
  const [playlists, setPlaylists] = useLocalStorage<LocalPlaylist[]>('yt_clone_playlists', []);
  ...
  const addVideoToPlaylist = useCallback((playlistId: string, video: VideoSummary) => {
