...
export interface IVideoProvider {
  getTrendingVideos(regionCode?: string, maxResults?: number, pageToken?: string, videoCategoryId?: string, signal?: AbortSignal): Promise<PaginatedResponse<VideoSummary>>;
  getSearchSuggestions(query: string, signal?: AbortSignal): Promise<string[]>;
  getSearchVideos(query: string, maxResults?: number, pageToken?: string, filters?: SearchFilters, signal?: AbortSignal): Promise<PaginatedResponse<VideoSummary>>;
