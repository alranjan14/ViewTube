...
const Head = () => {
  ...
  return (
    <>
      <a
        href="#main-content"
        className="absolute top-0 left-0 z-[100] p-3 -translate-y-full focus:translate-y-0 bg-blue-600 text-white font-bold transition-transform"
      >
      ...
      <header className="sticky top-0 z-50 flex h-16 items-center justify-between px-4 lg:px-6 bg-white/80 backdrop-blur-lg border-b border-slate-200/50 shadow-sm transition-all">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/"
            className="flex items-center gap-2 group outline-none focus-visible:ring-2 focus-visible:ring-red-500 rounded-lg p-1"
            aria-label="ViewTube Home"
          >
        ...
        >
          ...
          >
            <Mic
              size={20}
              className={isListening ? 'text-red-600' : 'text-slate-700'}
            />
          </IconButton>
        </div>
